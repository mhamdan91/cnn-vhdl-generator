...
signal BIAS_1		: unsigned(PRECISION-1   downto 0);
signal ReLU_1		: unsigned(PRECISION-1   downto 0);
...
------------------------------------------------ PROCESS START------------------------------------------------------
	...
	if EN_LOC_STREAM_1='1' and EN_STREAM= '1' and OUT_PIXEL_COUNT<VALID_CYCLES  then    -- check valid data and enable stream
		...
		if Enable_STAGE_1 = '1' then
			------------------------------------STAGE-1--------------------------------------
--MULT_SIZE-1-WHOLE-PAD downto DECIMAL
			ADD_DEPTH_1(0,0)<=signed(MULT_1(0,0)(PRECISION-1 downto 0)) + signed(MULT_1(1,1)(PRECISION-1 downto 0));


			ADD_DEPTH_1(1,0)<=signed(MULT_1(0,1)(PRECISION-1 downto 0)) + signed(MULT_1(1,0)(PRECISION-1 downto 0));
		...
		if Enable_BIAS = '1' then
			...
			BIAS_1<=unsigned(BIAS_VAL_1) + unsigned(ADD_DEPTH_2(0,0));
