...
HD_PWD='C:/Users/mhamdan/Google Drive/PhD classes/My_other_stuff/cnn_vhdl_generator/generated_model/Vivado/tiny_model/tiny_model.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CONV_LAYER_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CONV_LAYER_1.tcl
